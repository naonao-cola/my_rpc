/**
 * @FilePath     : /my_rpc/src/common/percentile.hpp
 * @Description  :
 * @Author       : naonao
 * @Date         : 2025-05-01 14:30:54
 * @Version      : 0.0.1
 * @LastEditors  : naonao
 * @LastEditTime : 2025-05-01 14:30:55
...
public:
    Percentile() = default;
    Percentile(size_t maxStatDataLen)
        : max_stat_data_len_(maxStatDataLen)
    {
    }
