...
public:
    ...
    int Run(int argc, char* argv[])
    {
        ...
        failure_count_ = 0;
        success_count_ = 0;
        std::cout << kGreenBegin << "[==============================] Running " << test_cases_.size() << " test case." << kColorEnd << std::endl;
        ...
        std::cout << kGreenBegin << "[==============================] Total TestCase:" << test_cases_.size() << kColorEnd << std::endl;
...
#define TEST_CASE_CLASS(test_case_name)                                                                                                          \
    ...
    {                                                                                                                                            \
    public:                                                                                                                                      \
        test_case_name(std::string case_name)                                                                                                    \
            : UnitTest::TestCase(case_name)                                                                                                      \
        {                                                                                                                                        \
        }                                                                                                                                        \
        virtual void Run();                                                                                                                      \
                                                                                                                                                 \
    ...
    UnitTest::TestCase* const test_case_name::test_case_ = UnitTest::UnitTestCore::GetInstance()->Register(new test_case_name(#test_case_name)); \
...
#define ASSERT_EQ(left, right)                                                                                                         \
    if ((left) != (right)) {                                                                                                           \
        std::cout << UnitTest::kRedBegin << "assert_eq failed at " << __FILE__ << ":" << __LINE__ << ". " << (left) << "!=" << (right) \
                  << UnitTest::kColorEnd << std::endl;                                                                                 \
        SetResult(false);                                                                                                              \
        return;                                                                                                                        \
    }
...
#define ASSERT_NE(left, right)                                                                                                         \
    if ((left) == (right)) {                                                                                                           \
        std::cout << UnitTest::kRedBegin << "assert_ne failed at " << __FILE__ << ":" << __LINE__ << ". " << (left) << "==" << (right) \
                  << UnitTest::kColorEnd << std::endl;                                                                                 \
        SetResult(false);                                                                                                              \
        return;                                                                                                                        \
    }
...
#define ASSERT_LT(left, right)                                                                                                         \
    if ((left) >= (right)) {                                                                                                           \
        std::cout << UnitTest::kRedBegin << "assert_lt failed at " << __FILE__ << ":" << __LINE__ << ". " << (left) << ">=" << (right) \
                  << UnitTest::kColorEnd << std::endl;                                                                                 \
        SetResult(false);                                                                                                              \
        return;                                                                                                                        \
    }
...
#define ASSERT_LE(left, right)                                                                                                        \
    if ((left) > (right)) {                                                                                                           \
        std::cout << UnitTest::kRedBegin << "assert_le failed at " << __FILE__ << ":" << __LINE__ << ". " << (left) << ">" << (right) \
                  << UnitTest::kColorEnd << std::endl;                                                                                \
        SetResult(false);                                                                                                             \
        return;                                                                                                                       \
    }
...
#define ASSERT_GT(left, right)                                                                                                         \
    if ((left) <= (right)) {                                                                                                           \
        std::cout << UnitTest::kRedBegin << "assert_gt failed at " << __FILE__ << ":" << __LINE__ << ". " << (left) << "<=" << (right) \
                  << UnitTest::kColorEnd << std::endl;                                                                                 \
        SetResult(false);                                                                                                              \
        return;                                                                                                                        \
    }
...
#define ASSERT_GE(left, right)                                                                                                        \
    if ((left) < (right)) {                                                                                                           \
        std::cout << UnitTest::kRedBegin << "assert_ge failed at " << __FILE__ << ":" << __LINE__ << ". " << (left) << "<" << (right) \
                  << UnitTest::kColorEnd << std::endl;                                                                                \
        SetResult(false);                                                                                                             \
        return;                                                                                                                       \
    }
...
#define ASSERT_TRUE(expr)                                                                                                            \
    if (not(expr)) {                                                                                                                 \
        std::cout << UnitTest::kRedBegin << "assert_true failed at " << __FILE__ << ":" << __LINE__ << ". " << (expr) << " is false" \
                  << UnitTest::kColorEnd << std::endl;                                                                               \
        SetResult(false);                                                                                                            \
        return;                                                                                                                      \
    }
...
#define ASSERT_FALSE(expr)                                                                                                           \
    if ((expr)) {                                                                                                                    \
        std::cout << UnitTest::kRedBegin << "assert_false failed at " << __FILE__ << ":" << __LINE__ << ". " << (expr) << " if true" \
                  << UnitTest::kColorEnd << std::endl;                                                                               \
        SetResult(false);                                                                                                            \
        return;                                                                                                                      \
    }
...
#define RUN_ALL_TESTS()                                                \
    ...
    {                                                                  \
        return UnitTest::UnitTestCore::GetInstance()->Run(argc, argv); \
    }
}   // namespace UnitTest
